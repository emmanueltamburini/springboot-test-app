...
public class Data {
    public static final Account ACCOUNT_1 () {return new Account(1L, "PERSON TEST 1", new BigDecimal("1000"));}
    public static final Account ACCOUNT_2 () {return new Account(1L, "PERSON TEST 2", new BigDecimal("2000"));}
